...
def convertData(channel = 38):
    ...
    # adr = "E:/DataSet/data/N_C/channel" + str(channel) + "_clear.dat"
    # adrn = "E:/DataSet/data/N_C/channel" + str(channel) + "_noise.dat"
    # fout_data = open(adr,'w')
    # fout_data_n = open(adrn,'w')
    fout_data = open("E:/DataSet/data/features_MA_noise_less.dat",'w')
    ...
    for i in range(32):  #nUser #4, 40, 32, 40, 8064
        ...
        noise = numpy.loadtxt('E:\DataSet\MA1\MA' + str(i%10+1) + '.txt', delimiter=',')
        f = open(fname, 'rb')
